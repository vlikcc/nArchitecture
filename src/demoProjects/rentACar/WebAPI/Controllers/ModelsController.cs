using Application.Features.Brands.Queries.GetListModelByDynamic;
...
namespace WebAPI.Controllers
{
    ...
    public class ModelsController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> GetListModelByDynamic([FromQuery] PageRequest pageRequest, [FromBody] Dynamic dynamic)
        {
